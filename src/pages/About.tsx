import { Zap, Globe, Shield, Activity, Users, Heart } from 'lucide-react';
  ...
  return (
    <div className="max-w-3xl mx-auto flex flex-col gap-12 pb-16 px-4 md:px-0 page-enter">
      ...
      <div className="text-center md:text-left pt-6">
        <p className="text-[11px] font-mono uppercase tracking-[0.25em] text-[#00bfa5] mb-4 font-semibold">
        ...
        >
          Motion into <span className="bg-gradient-to-r from-[#00bfa5] to-[#3cd0bc] bg-clip-text text-transparent">meaning.</span>
        </h1>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {MISSION_STATS.map(v => (
            <Card key={v.label} padding="md" className="bg-white/[0.02] dark:bg-white/[0.01] border border-black/[0.06] dark:border-white/[0.06] backdrop-blur-md rounded-2xl hover:border-[#00bfa5]/30 transition-all duration-300">
              <div className="w-10 h-10 rounded-xl bg-[#00bfa5]/[0.08] flex items-center justify-center text-[#00bfa5] mb-5">
                <v.icon size={20} />
              </div>
        ...
        {IMPACT_STORY.map((story) => (
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              <story.icon size={16} className="text-[#00bfa5]" />
      ...
      <div className="relative overflow-hidden p-8 rounded-2xl bg-gradient-to-r from-[#00bfa5]/[0.05] via-[#00bfa5]/[0.02] to-transparent border border-[#00bfa5]/10 text-center md:text-left">
        ...
        <div className="absolute top-1/2 right-4 -translate-y-1/2 opacity-5 hidden md:block">
          <Zap size={120} className="text-[#00bfa5]" />
        </div>
      </div>
